            ...
            <tr>
                <td colspan="2">
                    <div style="padding:37px 36px 85px; font-family:Arial, Helvetica, sans-serif; font-size:13px; line-height:1.3;">
                        ...
                        Мы отправили это письмо, потому что вы или кто-то другой указал этот адрес в приложении БУДУТАМ.<br />
                        Ваш новый пароль - <?php print $password; ?>
                        
                        <br /><br />
                        Верифицируйте свой аккаунт с помощь skype или hangouts, чтобы получить полный доступ к приложению! <br />
