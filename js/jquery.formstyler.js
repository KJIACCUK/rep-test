							...
							function doSelect() {
								...
								var selectbox =
									$('<div' + att.id + ' class="jq-selectbox jqselect' + att.classes + '" style="display: inline-block; position: relative; z-index:' + opt.singleSelectzIndex + '">' +
											'<div class="jq-selectbox__select inp_tx"' + att.title + ' style="position: relative"><div class="inp_txr"></div>'+'<div class="inp_txl"></div>'+
								...
								var dropdown =
									$('<div class="jq-selectbox__dropdown" style="position: absolute"><div class="ico_uk"></div>' +
											searchHTML +
